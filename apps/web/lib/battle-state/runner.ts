...
async function judgeBattle(state: BattleState): Promise<VerdictBundle> {
  ...
  const judgeSystem = [
    ...
    "",
    "SAME-STANCE RULE: If both fighters argue the same position on the topic,",
    "do NOT call it a draw. Instead judge on rhetorical quality: whose",
    "arguments were better structured, more evidence-backed, and more",
    "persuasive? Pick the fighter who made the shared case more compellingly.",
    "",
